...
namespace Pathfinder.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
