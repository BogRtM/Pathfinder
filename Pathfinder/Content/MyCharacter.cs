...
namespace PathfinderMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public const string HENRY_PREFIX = PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_";
        ...
        {
            bodyName = "HenryBody",
            bodyNameToken = PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_NAME",
            subtitleNameToken = PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_SUBTITLE",
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(PathfinderPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_DEFAULT_SKIN_NAME",
